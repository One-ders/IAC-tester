...
//#include_next "config.h"  this is for driver include....
//Here we include this file direct into the usr main
...
#define COIL1A	GPIO_PIN(GPIO_PB,0)
#define COIL1B  GPIO_PIN(GPIO_PB,1)
#define COIL2A	GPIO_PIN(GPIO_PB,2)
#define COIL2B  GPIO_PIN(GPIO_PB,3)
